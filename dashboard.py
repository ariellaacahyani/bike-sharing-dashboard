...
try:
    ...
    st.write("Error di visualisasi 1 (Hourly):", e)
...
try:
    ...
    st.write("Error di visualisasi 2 (Hari Kerja vs Libur):", e)
...
try:
    ...
    st.write("Error di visualisasi 3 (Pola Permintaan Mingguan):", e)
